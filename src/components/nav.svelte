<nav class="bg-theme px-8 pt-2 shadow-md">
	<div class="-mb-px flex justify-center">
		...
		<a
			class="no-underline text-grey-dark border-b-2 border-teal-dark uppercase tracking-wide font-bold text-xs py-3 mr-8"
			href="/events"
		>
			Events
		</a>
